...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`top-0 left-0 w-full z-50 transition-all duration-500 transform ${
                  ...
                  <div key={link.name} className="relative flex items-center justify-center">
                    ...
                    >
                      <Typography
                        ...
                        className={`navbar tracking-wide transition-colors duration-300 group-hover:text-primary ${
                ...
                <div key={link.name} className="relative border-b border-gray-100">
                  ...
                  >
                    <Typography
                      variant="span"
                      color={isActive ? "primary" : "dark"}
                      className={`navbar group-hover:text-primary transition-colors ${
                        isActive ? "font-semibold" : ""
                      }`}
                    >
                      {link.name}
