    ...
    <section className="w-full py-16  bg-[#171717] overflow-hidden">
      <div className="custom-container flex flex-col gap-10 lg:gap-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 xl:gap-8 w-full">
          <div className="w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-xl border border-white/20" data-aos="fade-up" data-aos-delay="100">
            <img 
          ...
          <div className="w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-xl border border-white/20" data-aos="fade-up" data-aos-delay="200">
            <img 
        ...
        {/* Bottom Block: Text on Left, Button on Right on >1500px */}
