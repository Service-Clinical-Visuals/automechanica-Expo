    ...
    >
      ...
      <div className="custom-container relative z-20 w-full mt-20  md:mt-[50%]  xl:mt-[25%]">
        <div
          ...
          data-aos-delay="200"
        >
          <Typography variant="h1" weight="semibold" className="font-oswald text-white tracking-normal   leading-tight mb-6">
          ...
          >
            Delivering premium automotive parts and innovative solutions with exceptional quality, reliability, and performance for workshops, dealers, and drivers worldwide.
          </Typography>
