...
const Button = ({
  ...
  const content = (
    <div className={`flex items-center justify-center gap-3 sm:gap-4 px-8 py-3 bg-primary text-white hover:bg-primary-hover transition-colors rounded-lg shadow-sm ${className}`}>
