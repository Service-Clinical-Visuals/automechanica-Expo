        ...
        <div className="relative z-10 pb-20 md:pb-32 lg:pb-40">
          <div
            ...
            <h1 className="heading-white tracking-[0%] font-normal! text-[48px]! leading-[130%]! text-white">
              We are your contact when it comes to <br /> cooling and air
              conditioning
            </h1>
          </div>
          <button className="heading text-primary! rounded-tr-[16px] rounded-bl-[16px] mt-4 text-[24px]! uppercase  bg-white px-6 py-1.5 hover:bg-white/90 transition-colors">
            Explore Products
          </button>
        </div>
      </Container>
