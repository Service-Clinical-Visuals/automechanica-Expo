...
export default function Header() {
  ...
  return (
    <header 
      className="w-full flex flex-col fixed top-0 left-0 right-0 z-50 bg-white"
      data-aos="fade-down"
      ...
      <div className="w-full bg-white py-2">
        <div className="custom-container flex flex-col sm:flex-row justify-center sm:justify-between items-center gap-2 sm:gap-0">
          <div className="flex gap-4 sm:gap-6 items-center">
            <a href="tel:+48228646700" className="flex items-center gap-2 group">
              <img 
            ...
            <a href="mailto:biuro@denckermann.pl" className="flex items-center gap-2 group">
              <img 
          ...
          <div className="flex gap-4 xl:gap-6 items-center hidden xl:flex">
            <Link href="#" className="header-top-link font-normal text-[#122337] hover:text-[var(--color-secondary)] transition-colors oswald">
      ...
      <div className="w-full bg-[var(--color-primary)] py-4">
        <div className="custom-container flex justify-between items-center">
          ...
          <nav className="hidden xl:flex gap-4 2xl:gap-8 items-center">
            {["Home", "About Us", "Products", "Blog", "Contact", "Downloads"].map((item) => (
              <Link 
                key={item} 
                href="#" 
          ...
          <div className="flex gap-3 items-center">
            <button className="flex items-center gap-1 sm:gap-2 bg-white px-1 sm:px-3 py-1 sm:py-2 rounded-sm">
              ...
              />
              <span className="header-link font-normal text-[#122337] oswald">PL</span>
              <img 
      ...
      >
        <div className="flex flex-col px-6 py-4 gap-4">
          {["Home", "About Us", "Products", "Blog", "Contact", "Downloads"].map((item) => (
            ...
            <Link href="#" className="text-white header-top-link font-normal hover:text-[var(--color-secondary)] transition-colors py-2 border-b border-white/10 oswald flex items-center justify-between ">Product Search Engine <span className="text-[var(--color-secondary)]">→</span></Link>
            <Link href="#" className="text-white header-top-link font-normal hover:text-[var(--color-secondary)] transition-colors py-2 border-b border-white/10 oswald flex items-center justify-between ">Distributor Zone <span className="text-[var(--color-secondary)]">→</span></Link>
          </div>
        </div>
    </header>
  );
