...
export default function Button({ href, text }: ButtonProps) {
  return (
    <Link href={href} className="inline-flex items-stretch border border-[#0E4194] hover:shadow-md transition-shadow duration-300 self-start group">
      <div className="bg-[#0E4194] group-hover:bg-[#0a3170] transition-colors text-white px-6 md:px-8 py-2 md:py-2.5 flex items-center justify-center  text-sm md:text-[16px] 4xl:text-[18px] font-semibold oswald tracking-wide">
        {text}
      </div>
