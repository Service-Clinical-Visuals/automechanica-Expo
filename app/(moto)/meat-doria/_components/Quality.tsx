      ...
      <Container>
        <div
          ...
          <div className="flex flex-col justify-center order-1 xl:order-2">
            <h2 className="heading text-[24px]! mb-6">
              Engineered for Compressor
            </h2>
            <p className="content text-[16px]! mb-4">
              Engineered for reliable cooling performance, Meat &amp; Doria
              automotive A/C compressors are designed to restore efficient
              climate control across a wide range of passenger and commercial
              vehicles. Manufactured to meet high-quality standards, they
