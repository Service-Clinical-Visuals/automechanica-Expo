    ...
    <section className="py-16 bg-secondary">
      <div className="custom-container">
        ...
        <div className="flex flex-col items-center text-center mb-16 px-4" data-aos="fade-up">
          ...
          <Typography variant="p" color="white" className="max-w-[80%] leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {newsItems.map((item, index) => (
            <div 
              key={item.id} 
              className="bg-white flex flex-col shadow-lg transition-transform hover:-translate-y-2 duration-300"
              data-aos="fade-up"
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <div className="flex gap-4">
            <button className="w-12 h-12 rounded-full bg-primary flex items-center justify-center text-white hover:bg-red-700 transition-colors cursor-pointer shadow-md">
              <ArrowLeft size={24} />
            </button>
            <button className="w-12 h-12 rounded-full bg-primary flex items-center justify-center text-white hover:bg-red-700 transition-colors cursor-pointer shadow-md">
              <ArrowRight size={24} />
