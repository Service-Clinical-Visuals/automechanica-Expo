...
export default function PowerSection() {
  ...
  return (
    <section className="relative w-full py-16  bg-primary" data-aos="fade-up">
      <div className="custom-container flex flex-col">
        ...
        {/* Divider */}
        <div className="w-full h-px bg-white/60 mb-8 xl:mb-12"></div>

        {/* Bottom Media and Features Grid */}
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 lg:gap-12">

          {/* Left: Video Player */}
          <div className="xl:col-span-7 order-1 w-full aspect-video relative overflow-hidden shadow-2xl flex items-center justify-center">
