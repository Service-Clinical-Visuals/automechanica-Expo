            ...
            <div className="w-full pb-8 sm:pb-16 md:pb-20 lg:pb-24">
              <div className="max-w-[720px]">
                ...
                <div data-aos="fade-up">
                  <h2 className="heading-white text-[40px]! font-normal! max-w-[400px] text-white mb-2.5">
                    Stronger together.
                  </h2>
                  <p className="content-white">
                    The widest range of spare parts in the world for the aftermarket in a single group.
                  </p>
                </div>
              </div>
            </div>
