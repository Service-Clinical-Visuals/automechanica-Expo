...
export default function ProductRange() {
  ...
  return (
    <section className="w-full py-16 lg:py-24 bg-[#1e1e1e]">
              ...
              {products.slice(0, 5).map((product, index) => (
                ...
                >
                  ...
                  <div className="flex flex-col flex-grow mt-2">
                    <h3 className="img-title font-semibold text-[#333333] mb-3 pb-3 border-b border-gray-200 ">{product.title}</h3>
                    <p className="img-text text-[#6E777D] leading-[1.6] mb-1 flex-grow font-normal">
                      {product.description}
                    </p>
                    <Link href="#" className="text-[#E72E39] font-bold hover:underline tracking-wide img-text mt-2 lg:mt-4 underline inline-block">
                      Read More &gt;&gt;
                    </Link>
                  </div>
                </div>
