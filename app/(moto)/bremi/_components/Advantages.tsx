    ...
    <section className="relative w-full pb-16 lg:pb-24 bg-white">
      ...
      <div className="custom-container relative z-10 pt-16 lg:pt-24">
        ...
        <div className="text-center max-w-5xl mx-auto mb-12 lg:mb-16" data-aos="fade-up">
           ...
           <p className="section-text text-white leading-[1.6] font-normal">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-4 gap-10 mb-12 lg:mb-16">
           {advantagesData.map((item, index) => (
             ...
             >
               <h3 className="card-title1 font-semibold text-[#333333] mb-4 h-[80px] mt-8 flex items-center justify-center whitespace-pre-line ">
                  {item.title}
               </h3>
               ...
               <Link href="#" className="text-[#E72E39] font-bold hover:underline tracking-wide img-text mt-2 lg:mt-2 mb-8  inline-block underline">
                      Read More &gt;&gt;
                    </Link>
             </div>
           ))}
