  ...
  return (
    <section className="pt-20 xl:pt-20 w-full bg-[#1e1e1e]">
      <div className="custom-container overflow-hidden">
        {/* Header */}
        <div className="text-center max-w-4xl min-[2560px]:max-w-[70%] min-[3800px]:max-w-[80%] mx-auto mb-12 lg:mb-16" data-aos="fade-up">
          <h2 className="section-title title-bordered text-[#E72E39] font-bold">
