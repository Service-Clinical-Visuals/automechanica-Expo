...
export default function Herobanner() {
  return (
    <div>
      ...
      <section className="relative  bg-white twok">
              ...
              <div className="max-w-[720px]">
                ...
                <div data-aos="fade-up">
                  ...
                  <p className="content mb-8">
                    Premium lubricants engineered for superior engine
                    protection, reliable performance, and long-lasting
                    efficiency across every journey and application.
                  </p>
