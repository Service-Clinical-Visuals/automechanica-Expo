    ...
    <section id="products" className="w-full bg-[#111111] py-16 md:py-24 text-white relative">
      <Container className="custom-container">
        ...
        <div className="flex flex-col items-center text-center max-w-full mx-auto mb-16 space-y-4" data-aos="fade-up">
          <Typography variant="h5" color="white" className="font-orbitron font-medium tracking-wide">
        ...
        <div className="w-full flex flex-col md:flex-row items-center gap-4 lg:gap-8">
          ...
          <div className="w-full flex-1 grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {products.map((product, index) => (
              <div key={product.id} className="flex flex-col items-center group cursor-pointer" data-aos="zoom-in-up" data-aos-delay={index * 150}>
                <div className="w-full aspect-square bg-[#1f1f1f] rounded-[16px] p-8 flex items-center justify-center transition-transform duration-300 group-hover:-translate-y-2 relative overflow-hidden">
                ...
                <div className="mt-6 text-center h-16 flex items-center justify-center">
                  <Typography variant="h3" color="muted" className="font-orbitron font-medium leading-relaxed uppercase whitespace-pre-line text-[#9D9D9D] group-hover:text-white transition-colors duration-300">
                    {product.name}
                  </Typography>
                </div>
              </div>
