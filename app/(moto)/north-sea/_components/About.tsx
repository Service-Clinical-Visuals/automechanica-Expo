    ...
    <section className="bg-white py-16">
      <Container>
        ...
        <div className="text-center max-w-3xl lg:max-w-[80%] mx-auto mb-10" data-aos="fade-up">
          <h2 className="heading text-[28px]! md:text-[32px]! mb-4">
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-center">
          ...
          <div className="w-full lg:w-[45%] space-y-5" data-aos="fade-left" data-aos-delay="150">
            <h3 className="text-[26px] font-bold text-[#1A1A1A] leading-tight">Key Features</h3>
            ...
            <div className="space-y-4">
              {FEATURES.map((feature) => (
                <div key={feature.title} className="flex items-start gap-3">
                  ...
                  <p className="content text-[16px]! leading-[150%]!">
