    ...
    <section className="py-16 md:py-24 bg-[#0D3374] text-white">
      <div className="custom-container">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 lg:gap-10">
          ...
          {/* Left: Text Content */}
          <div data-aos="fade-right" className="xl:col-span-5 flex flex-col gap-4 text-[#ffffff] section-text lato-font">
            <p>
            ...
            <p>
              It helps maintain consistent airflow while reducing dust, allergens, and unpleasant odors.
              Its durable construction and OEM-fit design ensure long-lasting performance, making it
              a dependable choice for comfortable, clean, and healthy driving in all conditions.
            </p>
            
            <div className="flex flex-col gap-6 mt-4 xl:hidden 2xl:flex">
              {/* Feature 1 */}
              <div className="flex items-start gap-4">
                ...
                <p className="text-[#ffffff] section-text lato-font">
                  ...
                  Activated carbon variants help minimize unpleasant odors and certain
                  pollutants
                </p>
              </div>
