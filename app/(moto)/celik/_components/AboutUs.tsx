...
const AboutUs = () => {
  return (
    <section id="about" className="w-full py-16 min-[2100px]:py-24 min-[3800px]:py-25 bg-white overflow-hidden">
      <div className="custom-container flex flex-col xl:grid xl:grid-cols-12 gap-10 xl:gap-16 min-[2100px]:gap-20 min-[3800px]:gap-32 items-center">
        
        {/* Heading Group - Mobile Order 1, Desktop Row 1 Left */}
        <div className="order-1 xl:col-start-1 xl:col-span-6 xl:row-start-1 flex flex-col gap-4 w-full" data-aos="fade-right">
        ...
        {/* Image - Mobile Order 2, Desktop Span Rows 1-2 Right */}
        <div className="order-2 xl:col-start-7 xl:col-span-6 xl:row-start-1 xl:row-span-2 w-full h-full flex items-center justify-center min-[2100px]:min-h-[500px] min-[3800px]:min-h-[800px]" data-aos="fade-left">
          <img
        ...
        {/* Body and Button - Mobile Order 3, Desktop Row 2 Left */}
        <div className="order-3 xl:col-start-1 xl:col-span-6 xl:row-start-2 flex flex-col gap-6 w-full" data-aos="fade-right">
