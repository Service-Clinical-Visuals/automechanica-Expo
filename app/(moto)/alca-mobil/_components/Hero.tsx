  ...
  return (
    ...
    >
      ...
      <div className="custom-container relative z-20 w-full px-4 sm:px-6">
        <div
          className="xl:max-w-[40%] max-w-full text-left space-y-6 pointer-events-auto"
        >
          {/* Header Title  */}
          <Typography
            variant="h1"
          ...
          >
            Driving Global Automotive Logistics & Service Excellence
          </Typography>

          <div className="pt-2" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
            <Button text="Explore Our Services" href="#about" />
          </div>
        </div>
      </div>
    </section>
