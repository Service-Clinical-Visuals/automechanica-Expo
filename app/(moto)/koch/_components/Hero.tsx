    ...
    >
      ...
      <div className="custom-container relative z-20 w-full px-4 sm:px-6">
        ...
        >
          ...
          >
            Precision Wheel Alignment Solutions
          </Typography>

          <Typography
            variant="p"
            color="white"
            className="leading-relaxed w-full xl:max-w-[80%]"
            data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200"
          >
            Advanced alignment systems for cars, commercial vehicles, and agricultural machinery with accurate and reliable performance.
          </Typography>
        </div>
      </div>
    </section>
