...
const Button = ({
  ...
  const content = (
    <div className={`flex items-center justify-center px-8 py-2.5 bg-primary text-white hover:bg-primary-hover transition-colors rounded-[5px] shadow-sm ${className}`}>
