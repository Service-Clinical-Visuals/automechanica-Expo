  ...
  return (
    ...
    >
      ...
      <div className="custom-container relative z-20 w-full px-4 sm:px-6">
        <div
          className="xl:max-w-[70%] max-w-full text-left space-y-6 md:space-y-8 pointer-events-auto"
        >
          {/* Header Title  */}
          <Typography
            variant="h1"
          ...
          >
            Premium Brake Pads Engineered for<br className="hidden md:block"/> Maximum Safety
          </Typography>
