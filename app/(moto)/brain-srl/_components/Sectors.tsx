  ...
  return (
    <section className="w-full bg-[#F9F9F9] py-16 ">
      <div className="custom-container px-4 max-w-[1920px] mx-auto flex flex-col items-center">
        ...
        {/* Header */}
        <div className="flex flex-col items-center text-center  max-w-[50%] mx-auto mb-10 gap-4" data-aos="fade-up">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2  xl:grid-cols-2 2xl:grid-cols-4 gap-6 lg:gap-8  w-full">
          {sectors.map((sector, idx) => (
            <div
              key={idx}
              className="bg-primary rounded-tl-[2rem] rounded-br-[2rem] rounded-tr-none rounded-bl-none p-8 flex flex-col items-center text-center shadow-lg transition-transform hover:-translate-y-2 duration-300"
              data-aos="fade-up"
            ...
            >
              ...
              <Typography variant="p" color="white" font="lato" className="text-gray-300 text-sm leading-relaxed mb-8 flex-grow">
                {sector.text}
              </Typography>
