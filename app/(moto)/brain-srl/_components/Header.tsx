...
export default function Header() {
  ...
  return (
    <header
      className={`w-full fixed top-0 left-0 z-[100] bg-white shadow-md transition-all duration-500 ease-out ${isScrolled ? "translate-y-0 opacity-100" : "-translate-y-full opacity-0"
        }`}
    >
