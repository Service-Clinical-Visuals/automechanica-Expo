        ...
        <div className="grid grid-cols-2 md:grid-cols-2 xl:grid-cols-12 gap-x-6 gap-y-10 xl:gap-6 mb-16 xl:mb-20">
          ...
          <div className="col-span-2 md:col-span-2 xl:col-span-3 flex flex-col gap-6 xl:pr-6">
            <Link href="#" className="inline-block">
              <img src="/moto/kroon-oil/logo.png" alt="Kroon-Oil" className="h-16 w-auto object-contain" />
            </Link>
            <p className="text-[#ffffff] section-text leading-[1.8] font-normal oswald-font">
          ...
          <div className="col-span-2 md:col-span-1 xl:col-span-3 flex flex-col gap-6 xl:pr-6">
            ...
            <div className="relative mt-2">
              <input 
                ...
                className="w-full bg-white text-black text-sm xl:text-base rounded-md pl-4 pr-14 py-3.5 focus:outline-none focus:ring-2 focus:ring-[#FFCB05] oswald-font placeholder:text-gray-500"
              />
              <button className="absolute right-1.5 top-1.5 bottom-1.5 w-10 bg-[#FFCB05] hover:bg-[#e6b700] transition-colors rounded-md flex items-center justify-center">
