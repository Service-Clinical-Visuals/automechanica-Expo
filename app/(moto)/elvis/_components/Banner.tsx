...
export default function Banner() {
  return (
    <section className="relative w-full pt-[120px] md:pt-[140px] lg:pt-[160px] min-[2500px]:pt-[240px] min-[3800px]:pt-[320px] pb-8 lg:pb-12" data-aos="fade-up">
          ...
          <div className="absolute inset-0 z-20 pointer-events-none p-6 md:p-12 xl:p-16 flex flex-col justify-end">
            <div className="text-left  pointer-events-auto" data-aos="fade-up" data-aos-delay="200">
              <Typography variant="h1" color="white" className="leading-tight mb-4">
                Automotive, Lighting & Industrial Solutions Since 1938
              </Typography>
              <Typography variant="p" color="white" className=" mb-8 max-w-[70%] xl:max-w-[50%] leading-relaxed">
                Delivering trusted Automotive, Lighting, and Industrial solutions with Danish engineering, premium quality, and global expertise.
              </Typography>
            </div>
          </div>
