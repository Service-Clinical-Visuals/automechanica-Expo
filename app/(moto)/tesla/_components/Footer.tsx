    ...
    <footer className="bg-primary pt-16 md:pt-24 pb-6 border-t border-white/10 relative z-20" data-aos="fade-up">
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-12">
          ...
          {/* Left Side (Span 5) */}
          <div className="lg:col-span-5 flex flex-col gap-8 md:gap-12 pr-0 lg:pr-10" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
            {/* Logo & Desc */}
            <div className="flex flex-col items-start">
              <Link href="/" className="mb-6 inline-block">
                <img
                  ...
                  alt="Tesla Logo"
                  className="h-20 sm:h-25 w-[90%] max-w-[200px] object-contain"
                />
              </Link>
              <p className="footer-body text-white max-w-full lg:max-w-[90%] leading-relaxed">
            ...
            <div className="w-full flex flex-col"  >
              ...
              <div className="flex w-full gap-2 sm:gap-3 flex-col sm:flex-row">
                <input
                  ...
                  className="footer-body bg-white w-full sm:w-auto flex-grow px-4 py-3 outline-none text-gray-800"
                />
                <button className="bg-white w-full sm:w-auto px-4 py-3 hover:bg-gray-50 transition-colors flex items-center justify-center text-[#001B4B]">
          ...
          {/* Right Side (Span 7) */}
          <div className="lg:col-span-7 flex flex-col gap-12 justify-between">
            {/* Top Row: Links Grid */}
            ...
            <div className="flex flex-wrap justify-start lg:justify-end gap-4 lg:gap-8 text-white mt-auto pt-6 lg:border-none lg:pt-0" data-aos="fade-in"  >
